...
export default function EditExpenseCategory({
    ...
    useEffect(() => {
        if (singleExpenseCategory && singleExpenseCategory[0]) {
            formik.setFieldValue('amount', singleExpenseCategory[0].amount);
            formik.setFieldValue('category', {title:singleExpenseCategory[0].category});
            formik.setFieldValue('description', singleExpenseCategory[0].description);
            formik.setFieldValue('date', singleExpenseCategory[0].date);
            formik.setFieldValue('time', singleExpenseCategory[0].time);
        }
