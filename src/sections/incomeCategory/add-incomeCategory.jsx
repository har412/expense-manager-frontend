...
import { addIncomeCategory, getIncomeCategory } from 'src/redux/incomeCategory/incomeCategorySlice';
...
export default function AddIncomeCategory({
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      const response = await dispatch(addIncomeCategory(newData))
      if (response) {
