...
import EditIncome from './view/edit-income';
...
export default function UserTableRow({
  ...
  const handleDeleteIncome = () =>{
   ...
   const response = dispatch(deleteIncome(incomeId))
   if(response)
   {
    dispatch(getIncome())
   }
    ...
    <>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleDeleteIncome} color="error" autoFocus>
            Delete
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
          ...
          <EditIncome open={openEditBox} handleClose={handleCloseEditBox} handleOpen={handleOpenEditBox} incomeId={incomeId} />
